...
/**
 * 
 * Modified Dec 2021 Victor Wheeler to include Auto sens
 * 
 */
#ifndef DHT_H
#define DHT_H
...
public:
  ...
  void set_sensor_typ(uint8_t type);	// *NEW* VW> Change the sensor type while live
  bool is_Valid();						// *NEW* VW> to expose _lastresult for Auto Select
private:
  uint8_t data[5];
  uint8_t _pin, _type;
#ifdef __AVR
