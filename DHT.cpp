...
/*!
 *  @brief  Expose the status of the last read result
 */
bool DHT::is_Valid(){						// *NEW* V.W>
	return _lastresult;
}

/*!
 *  @breif  Change the sensor type
 *  @param  type
 *  		The new sensor type DHT11 DHT22 ...
 */
void DHT::set_sensor_typ(uint8_t type){		// *NEW* V.W>
	_type = type;
	begin(pullTime);
}
